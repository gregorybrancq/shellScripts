...
"""
saveAndRestoreWindows.py: save windows position in viewport every X times
    and restore them when disconnect the external monitors.

More specifically:

- save windows position in xml file
- restore windows position from xml file
- detect when external monitors are disconnected

You may also need to install wmctrl and xwit.
Code:
    sudo apt install wmctrl xwit python-wnck
...
def get_screen():
    ...
    screen.force_update()
    print "DBG get_screen="+str(screen)
    return screen
...
def get_windows():
    ...
    print "DBG get_windows="+str(allWindows)
    for win in allWindows :
        print "DBG get_windows win.get_name="+str(win.get_name())
        print "DBG get_windows win.get_geometry="+str(win.get_geometry())
    return allWindows
...
def get_tasklist_windows():
    ...
    print "DBG get_tasklist_windows="+str(tasklistWindows)
...
def get_viewport_windows(): 
    ...
    print "DBG get_viewport_windows="+str(viewportWindows)
...
def get_eligible_windows():
    ...
    print "DBG get_eligible_windows="+str(eligibleWindows)
...
def get_ineligible_windows():
    ...
    print "DBG get_ineligible_windows="+str(ineligibleWindows)
...
def get_active_window():
    ...
    print "DBG get_active_window="+str(activeWindow)
    return activeWindow
...
def determine_minimized(windows):
    ...
    print "DBG gdetermine_minimized="+str(minimizedWindows)
